...
```bash
git clone https://github.com/frank-dkvan/nexora2.git && cd nexora2
cargo build --release
```
...
| `GET` | `/api/graph/history` | Time-travel query |
| `GET/PUT` | `/api/graph/node/{qid}/property/{key}` | Node property CRUD |
| `GET/POST` | `/api/graph/node/{qid}/edges` | Edge operations |
| `POST` | `/api/vector/search` | Vector similarity search |
| `POST` | `/api/ingest/file` | Start file ingestion |
| `GET/POST` | `/api/standing-query` | Standing Query management |
| `GET/POST` | `/api/materialized-views` | Materialized view management |
| `GET/POST` | `/api/udf/...` | UDF management |
| `GET` | `/api/health` | Health check (with uptime) |
| `GET` | `/metrics` | Prometheus metrics |

Full OpenAPI spec: **http://localhost:8080/api/openapi.json**
